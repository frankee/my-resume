...
\address{}{上海市长宁区}                       % optional, remove the line if not wanted
...
\section{工作经历}
\subsection{2006.03--现在}{上海梦擎信息科技有限公司}
...
非业务系统包含使用LVS、Nginx、Varnish的接入层系统，运维相关的日志及监控系统，以及其他队列、缓存、nosql系统。
\begin{itemize}%
...
\section{科研经历}
\subsection{2003.03--2006.02}{上海交通大学机器人研究所}
...
\cvline{语言}{\small 精通C++, 熟悉Java}
\cvline{工具}{\small Linux, boost, poco, gtest, Protobuf, ACE, MySql, Redis, MongoDB, Sphinx, svn, git, Redmine}
