...
\address{}{Changning District, Shanghai}    % optional, remove the line if not wanted
...
\subsection{2006.03--now}{Shanghai Astrob Information Technology Co., Ltd.}
...
ALP V2 is a web map system, like google maps, provide SDK
 ...
 the access layer system using LVS, Nginx, Varnish, logging and monitoring system.
\begin{itemize}%
...
\subsection{2003.03--2006.02}{Robot Research Institute of JiaoTong University}
...
\cvline{Language}{\small Expert knowledge in C++, familiar with Java}
\cvline{Tools}{\small Linux, boost, poco, gtest, Protobuf, ACE, MySql, Redis, MongoDB, Sphinx, svn, git, Redmine}
